...
// Placeholder video sources removed
    ...
    <section>
      ...
      >
        ...
        <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', zIndex: 0 }}>
          ...
          {/* ── VIDEO background ── */}
          {heroMediaType === 'video' && !heroLoading && src && (
            <video
              ref={videoRef}
              key={src}
              autoPlay
          ...
          {heroLoading && (
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#041a0c', zIndex: 2 }}>
              ...
              <svg
                ...
                style={{ animation: 'plane-fly 2s ease-in-out infinite' }}
              >
                <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.2-1.1.6L3 8l7 4-3 3-3.2-.8c-.4-.1-.8.1-1 .5L2 16l4 2 2 4 .9-.5c.3-.2.5-.7.4-1.2L8.5 17l3-3 4 7 1.2-.7c.4-.2.7-.6.6-1.1z" />
              </svg>
            </div>
          )}
        ...
        {/* ── Skip button ── */}
        {((heroMediaType === 'image' && carouselImages.length > 1) || (heroMediaType === 'video' && videos.length > 1)) && (
          <button
            onClick={() => {
