              ...
              {col.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onMouseLeave={e => {
                      if (item.isHeaderStyle) {
                        e.currentTarget.style.background = '#0f3a75';
...
const getLogoUrl = (logo) => {
  ...
  const baseUrl = process.env.NEXT_PUBLIC_BASE_IMAGE_URL || 'http://192.168.0.197:5001';
            ...
            <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
              ...
              >
                ...
                <MegaDropdown
                  ...
                  cols={[
                    [
                      { name: 'Currency', href: '/forex/currency', isExplore: true },
                      { name: 'Forex Card', href: '/forex/card', isExplore: true },
                      { name: 'International Transfer', href: '/forex/transfer', isExplore: true }
                    ]
                  ]}
                  isTransparent={false}
                />
