          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 32 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <div style={{ color: '#ffffff', fontSize: 13, fontWeight: 700, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                ...
                <div style={{ fontSize: 10, color: '#4b5563', fontWeight: 500, letterSpacing: 0.5 }}>8250 reviews</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <div style={{ color: '#ffffff', fontSize: 13, fontWeight: 700, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                ...
                <div style={{ fontSize: 10, color: '#4b5563', fontWeight: 500, letterSpacing: 0.5 }}>1440 reviews</div>
              </div>
            </div>
          </div>
        </div>
