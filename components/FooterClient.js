  ...
  return (
    <footer className="footer" style={{ background: '#0f3a75', color: '#ffffff' }}>
      ...
      <style jsx>{`
        ...
        .footer-social-btn-fb:hover { background: #1877F2 !important; border-color: #1877F2 !important; }
        .footer-social-btn-tw:hover { background: #000000 !important; border-color: #000000 !important; }
        .footer-social-btn-ig:hover { background: #E4405F !important; border-color: #E4405F !important; }
        .footer-social-btn-li:hover { background: #0A66C2 !important; border-color: #0A66C2 !important; }
