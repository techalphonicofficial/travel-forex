        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-4 text-lg-start mobile-text-center">
              ...
              <p className="mobile-mx-auto" style={{ color: 'rgba(255,255,255,0.6)', fontSize: 15, lineHeight: 1.8, maxWidth: 320, marginBottom: 24 }}>
                {brandDescription}
              </p>

              <div className="d-flex flex-column gap-2 mb-4">
                {phone && (
                  <a href={`tel:${phone}`} className="d-flex align-items-center gap-2 mobile-center-flex" style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14, textDecoration: 'none' }}>
                    <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
                ...
                {email && (
                  <a href={`mailto:${email}`} className="d-flex align-items-center gap-2 mobile-center-flex" style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14, textDecoration: 'none' }}>
                    <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
            ...
            {Object.entries(footerLinks).map(([section, links]) => (
              <div key={section} className="col-12 col-sm-6 col-lg-2 text-lg-start mobile-text-center mb-4 mb-lg-0">
                ...
                <h4 className="footer-heading mt-0">{section}</h4>
            ...
            <div className="col-12 col-sm-6 col-lg-2 text-lg-start mobile-text-center mb-4 mb-lg-0">
              <h4 className="footer-heading mt-0">Trust & Safety</h4>
              <div className="d-flex flex-column gap-3">
                {trustItems.map(({ icon, text }) => (
                  <div key={text} className="d-flex align-items-center gap-2 mobile-center-flex" style={{ color: 'rgba(255,255,255,0.65)', fontSize: 13 }}>
                    <TrustIcon icon={icon} />
                    <span>{text}</span>
                  </div>
                ))}
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="container">
          <div className="py-4 d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
            <p className="mobile-text-center" style={{ color: 'rgba(255,255,255,0.45)', fontSize: 14, margin: 0, whiteSpace: 'pre-line' }}>
              {footerContent}
            </p>
