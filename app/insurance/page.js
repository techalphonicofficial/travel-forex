    ...
    <main className="insurance-page">
      ...
      <section className="insurance-hero">
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <button className="btn-primary" style={{ padding: '16px 32px', fontSize: 16, fontWeight: 700, borderRadius: 30, border: 'none', background: 'white', color: 'var(--color-primary)', cursor: 'pointer', boxShadow: '0 4px 14px rgba(0,0,0,0.1)' }}>
            Get a Free Quote
          </button>
        </div>
      </section>
