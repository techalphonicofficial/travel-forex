...
const PIPELINE_FORM_ENDPOINT = 'https://asbestos-filling-thread-tear.trycloudflare.com/api/v1/crm/pipelines/3/form';
const COMPANY_INFO_ENDPOINT = 'https://asbestos-filling-thread-tear.trycloudflare.com/api/v1/crm/settings/company-info';
